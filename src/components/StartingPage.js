...
const StartingPage = () => {
    return (
        <div>
            ...
            <p>which will be used to come up with a new business idea. Feel free to also watch the futur's video on Youtube</p>
            <p>that this platform is based off of. You can always find a link to it in the nav bar.</p>

            <h3>For each category use the prompts below to help you think of ideas.</h3>
